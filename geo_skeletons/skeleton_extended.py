...
class SkeletonExtended:
    ...
    @classmethod
    def from_netcdf(
        cls, filename: str, name: Optional[str] = None, **kwargs
    ) -> "Skeleton":
        ...
        return cls.from_ds(ds, name=name, **kwargs)
    ...
    def name(self) -> str:
        return (
            self._ds_manager.get_attrs().get("_global_").get("name") or "LonelySkeleton"
        )
